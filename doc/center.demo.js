...
var domPos = function domPos(options) {
    ...
    requestAnimationFrame(function () {
        ...
        // set baseOn Offse
        options.el.$overallWidth = options.el.clientWidth + (0, _getBorderWidth2.default)(options.el).left + (0, _getBorderWidth2.default)(options.el).right;
        positionLeft = (0, _getBaseOnOffset2.default)(positionLeft, options.baseOn.el[0], options.el.$overallWidth, 'el');
        options.el.$overallHeight = options.el.clientHeight + (0, _getBorderWidth2.default)(options.el).top + (0, _getBorderWidth2.default)(options.el).bottom;
