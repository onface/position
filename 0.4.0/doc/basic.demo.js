...
/******/ 	__webpack_require__.p = "/position/0.4.0";
/******/
...
var domPos = function domPos(options) {
    ...
    // set baseOn Offse
    options.el.$overallWidth = options.el.clientWidth + (0, _getBorderWidth2.default)(options.el).left + (0, _getBorderWidth2.default)(options.el).right, 'el';
    positionLeft = (0, _getBaseOnOffset2.default)(positionLeft, options.baseOn.el[0], options.el.$overallWidth);
    options.el.$overallHeight = options.el.clientHeight + (0, _getBorderWidth2.default)(options.el).top + (0, _getBorderWidth2.default)(options.el).bottom, 'el';
    positionTop = (0, _getBaseOnOffset2.default)(positionTop, options.baseOn.el[1], options.el.$overallHeight);
    options.target.$overallWidth = options.target.clientWidth + (0, _getBorderWidth2.default)(options.target).left + (0, _getBorderWidth2.default)(options.target).right;
    options.target.$overallHeight = options.target.clientHeight + (0, _getBorderWidth2.default)(options.target).top + (0, _getBorderWidth2.default)(options.target).bottom;
    ...
    if (typeof position === 'undefined') {
        throw new Error('node_modules/dom-position: domPos(options) options.onPosition must be return `{left: Number, top: Number}`');
    }
